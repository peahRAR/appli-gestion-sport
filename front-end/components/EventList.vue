            ...
            <td class="px-3 py-2 whitespace-nowrap text-sm font-semibold text-text">
              <div class="flex items-center justify-center gap-3">
                <label class="relative inline-flex items-center cursor-pointer select-none">
                  ...
                  <div
                    class="w-10 h-5 bg-bg rounded-full peer-checked:bg-green-500 transition-colors duration-200">
                  </div>
                  <div
                    class="absolute left-0.5 top-0.5 w-4 h-4 bg-surface rounded-full transition-transform duration-200 peer-checked:translate-x-5">
                  </div>
                </label>
