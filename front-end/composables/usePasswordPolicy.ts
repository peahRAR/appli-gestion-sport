// Single source of truth (front-end side) for the password complexity rule.
// Mirrored 1:1 in back-end/src/common/validators/password-policy.ts (front and
// back can't share code across the two deployed apps) — keep both literals
// identical.
...
export function usePasswordPolicy() {
  return { PASSWORD_REGEX, PASSWORD_SPECIAL_CHARS, PASSWORD_RULE_MESSAGE, isValidPassword };
}
