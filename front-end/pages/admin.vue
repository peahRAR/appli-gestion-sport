<template>
    ...
    <TheModal :isOpen="showModalSelectedUser" title="Informations utilisateurs" @close="closeModalUser">
        <!-- Modale Utilisateur  -->
        <!-- Input Name -->
        <div class="mb-2 mt-4">
            <label for="username"><strong>Nom:</strong></label>
            <input class="border border-gray-500 p-1" type="text" v-model="selectedUser.name.data" id="username">
        </div>
        <!-- Input Firstname -->
        <div class="mb-2">
            <label for="userfirstname"><strong>Prénom:</strong></label>
            <input class="border border-gray-500 p-1" type="text" v-model="selectedUser.firstname.data"
                id="userfirstname">
        </div>
        ...
        <!-- Birthday -->
        <p class="mb-2"><strong>Date de naissance:</strong> {{ formatDate(selectedUser.birthday.data) }}</p>
        <!-- Gender -->
        <p class="mb-2"><strong>Genre:</strong> {{ selectedUser.gender ? 'Homme' : 'Femme' }}</p>
        <!-- Weight -->
        <p><strong>Poids:</strong> {{ selectedUser.weight && selectedUser.weight.data + 'Kg' || 'Non renseigné' }}</p>
        <!-- Tel Medic -->
        <p class="mb-2"><strong>Téléphone médical:</strong> {{ selectedUser.tel_medic && selectedUser.tel_medic.data
                            ||
                            'Non renseigné' }}</p>
        <!-- Tel emergency -->
        <p class="mb-2"><strong>Téléphone d'urgence:</strong> {{ selectedUser.tel_emergency &&
        ...
        <div class="mb-2">
            ...
            <input class="border border-gray-500 p-1" type="date" v-model="selectedUser.date_payment" id="datePayment">
        ...
        <div class="mb-2">
            ...
            <input class="border border-gray-500 p-1" type="date" v-model="selectedUser.date_end_pay" id="dateEndPay">
        ...
        <div class="flex flex-row justify-between">
            ...
            <div v-if="getUserRole() === 2">
                <button v-if="selectedUser.role === 0" @click="changeUserRole(selectedUser.id)"
                    class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Passer
                    Admin</button>
            </div>
        </div>
