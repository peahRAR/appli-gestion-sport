  ...
  <div class="p-4">
    <div class="flex flex-col items-center rounded py-8 px-4 bg-gray-50 min-h-screen">
      ...
      <div class="flex flex-col items-center w-full">
        ...
        <!-- Étape 1 -->
        <div class="flex flex-col items-center w-full">
          <div class="flex items-center justify-center w-24 h-24 rounded-full bg-gray-300 text-gray-800 text-3xl font-bold">
            1
          </div>
          ...
          <div class="mt-4">
            ...
            <template v-else-if="current?.code === 'FMMAF'">
              ...
              <p class="text-sm text-gray-600 mt-3 max-w-xl text-center">
                La FMMAF se déclare par e-mail, rassemble les justificatifs indiqués sur la page, puis envoie le tout selon leurs consignes.
              </p>
            </template>
        ...
        <div class="flex flex-col items-center w-full">
          ...
          <p class="mt-4 text-center text-gray-700 px-4 md:px-16">
            Prépare les pièces demandées, certificat médical, compte-rendu, facture, photos si pertinent, puis joins-les à ta déclaration.
          </p>
          <div class="w-4/5 border-t-4 border-gray-300 my-8"></div>
        </div>
        ...
        <div class="flex flex-col items-center w-full">
          ...
          <p class="mt-4 text-center text-gray-700 px-4 md:px-16">
            ...
            <a href="mailto:mmabaisieux@gmail.com" class="text-blue-600 underline">mmabaisieux@gmail.com</a>,
            précise que tu as fait les démarches, indique la fédération concernée, joins la référence ou l’accusé de réception si tu l’as.
          </p>
